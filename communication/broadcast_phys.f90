...
!==========================Added input for SPI model===========================================
  ...
  call MPI_PACK(nsubstep_electrons,     1,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(tstep_particles,        1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(T_scale_factor,         1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(B_scale_factor,         1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(ei_small_angle_scattering_Orb5,1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(ei_small_angle_scattering_Lu,  1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  ...
  call MPI_PACK(filter_gk_hyper,        1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(filter_gk_par,          1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(filter_gk_hyper_n0,     1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(filter_gk_par_n0,       1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
!==========================Added input for SPI model===========================================
  ...
  call MPI_UNPACK(buffer,bufsize,position,nsubstep_electrons,     1,MPI_INTEGER,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,tstep_particles,        1,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,T_scale_factor,         1,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,B_scale_factor,         1,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,ei_small_angle_scattering_Orb5,1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,ei_small_angle_scattering_Lu,  1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  ...
  call MPI_UNPACK(buffer,bufsize,position,filter_gk_hyper,        1,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,filter_gk_par,          1,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,filter_gk_hyper_n0,     1,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,filter_gk_par_n0,       1,MPI_REAL8,MPI_COMM_WORLD,ierr)
