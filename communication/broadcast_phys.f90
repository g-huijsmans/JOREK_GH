...
!==========================Added input for SPI model===========================================
  ...
  call MPI_PACK(wall_transition_partition,1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(wall_transition_R,2,MPI_DOUBLE_PRECISION,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(wall_transition_Z,2,MPI_DOUBLE_PRECISION,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(wall_transition_window,1,MPI_DOUBLE_PRECISION,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
!==========================Added input for SPI model===========================================
  ...
  call MPI_UNPACK(buffer,bufsize,position,wall_transition_partition,1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,wall_transition_R,2,MPI_DOUBLE_PRECISION,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,wall_transition_Z,2,MPI_DOUBLE_PRECISION,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,wall_transition_window,1,MPI_DOUBLE_PRECISION,MPI_COMM_WORLD,ierr)
