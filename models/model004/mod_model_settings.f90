...
! ##################################################################################################
  ...
  integer, parameter :: jorek_model    = 004       !< JOREK physics model (Hasegawa-Wakatani in this case)

  logical, parameter :: hydrodynamics   = .false.
  logical, parameter :: reduced_MHD     = .true.   !< Because HW looks a lot like reduced-MHD
  ...
  integer, parameter :: var_rho  = 3                       ! place of variable density                     (r or rho)
