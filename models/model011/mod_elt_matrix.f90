...
contains
  ...
  subroutine element_matrix(element, nodes, xpoint2, xcase2, R_axis, Z_axis, psi_axis, psi_bnd, &
    ...
    use mod_parameters,            only: n_vertex_max, n_degrees, n_plane, var_psi, var_rho
    ...
    use phys_module,               only: F0, central_mass, filter_hyper_n0, filter_par_n0, mode, mode_type
    ...
    real*8             :: psi_s, psi_t, psi_x, psi_y, rho
    ...
    real*8             :: block_a(basis_size,basis_size), block_b(basis_size,basis_size)
    ...
    do ms = 1, n_gauss
      do mt = 1, n_gauss
        ...
        psi_s = 0.d0; psi_t = 0.d0; rho = 0.d0
        ...
        call accumulate_poisson_blocks(weight, big_r, xjac, factor, bb2, psi_x, psi_y, &
             filter_hyper_n0, filter_par_n0, value, deriv_x, deriv_y, laplace_star, block_a, block_b)
      enddo
    enddo
    ...
    call scatter_poisson_harmonics(block_a, block_b, component_modes, component_types, n_plane, ELM)
